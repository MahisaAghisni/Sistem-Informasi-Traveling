                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="rating-box d-flex align-items-center">
                                            <?php
                                            if (isset($wisataRating[$destination_data['nama_tempat']]['totalRating']) && isset($wisataRating[$destination_data['nama_tempat']]['jumlahReview']) && $wisataRating[$destination_data['nama_tempat']]['jumlahReview'] > 0) {
                                            ...
                                            ?>
                                                ...
                                                <p class="mb-0">
                                                    <?php echo "(" . $wisataRating[$destination_data['nama_tempat']]['jumlahReview'] . ")"; ?>
                                                </p>
                                            <?php
                                            } else {
                                            ?>
                                                <p class="average-rating" style="margin-top: 16px;">Belum ada rating</p>
                                            <?php
                                            }
                                            ?>
                                        </div>
